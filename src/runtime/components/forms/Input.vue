<template>
	<div class="input" :class="classes">
		<input :id="getId" ref="fieldEl" v-model="text" v-focus="focus" class="input-field"
			v-bind="{ type, name, placeholder, required, readonly, disabled, autocomplete, pattern, maxlength }"
